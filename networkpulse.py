...
import logging
logger = logging.getLogger("NetworkPulse")
logger.setLevel(logging.DEBUG)
fh = logging.FileHandler("networkpulse.log")
...
def get_config_var(sec, var):
	...
	try:
		path_config = "/opt/NetworkPulse/networkpulse.cfg"
		config = ConfigParser(interpolation=ExtendedInterpolation())
		config.read(path_config)
	except:
		logger.fatal('Check the config file, whether it exists and the path. Must be: /opt/NetworkPulse/networkpulse.cfg')
	try:
